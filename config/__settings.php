    ...
    'items' => [
        ...
        'moneyfusion_payment' => [
            ...
            'moneyfusion_api_url' => [
                ...
                'data_type' => 1,    // string
                'default' => '',
                'placeholder' => 'MoneyFusion API URL',
                'hide_value' => false,
                'ignore_empty' => true,
            ],
        ],
      ...
      //yoo-money end
        ...
        'integrations' => [
            ...
            'api_documentation_url' => [
                ...
                'data_type' => 1,     // string
                'default' => 'https://www.postman.com/aviation-geoscientist-25493234/wj-api-docs/collection/17404097-54d371a6-5bf0-4b30-9da7-268dcc0d39a0?sideView=agentMode',
                'hide_value' => false,
                'ignore_empty' => true,
                'validation_rules' => [
                    'required',
        ...
        'mobile_app_configuration' => [
            'enable_firebase_notification' => [
                'key' => 'enable_firebase_notification',
                'data_type' => 2,    // bool
                'default' => false,
            ],
            'firebase_service_account_data' => [
                'key'           => 'firebase_service_account_data',
                'data_type'     => 1,    // string,
                'placeholder'   => '',
                'default'       => '',
                'ignore_empty' => true
