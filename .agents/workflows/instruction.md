...
## 5. Règles Requis & Charte UI/UX (Obligatoires)
- **Préservation du code existant** : Ne jamais perturber ni détruire la logique existante pour effectuer un travail.
- **Interdiction des fonds gris** : Ne jamais utiliser de fonds gris tristes/génériques (`#eee`, `bg-gray`, etc.).
- **Texte & Icônes** : Éviter l'insertion d'icônes décoratives au milieu des paragraphes/textes.
- **Boutons** : Utiliser des intitulés de boutons courts et concis.
- **Thème** : Designer systématiquement en parfaite harmonie avec le thème graphique existant.
