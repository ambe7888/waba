...
<div class="container-fluid mt-lg--6">
    <div class="row" x-data="{isAdvanceBot:'interactive',botFlowUid:'{{ $botFlowUid }}',ntCampaignPresetMessage:null}">
        <!-- button -->
                ...
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <span class="form-group m-0 mr-3">
                            @if(hasVendorAccess('manage_bot_replies', 'manage_bot_flow_builder'))
                            ...
                            <template x-if="!isUnsavedContent">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a type="button" @click="isAdvanceBot = 'simple'" data-response-template="#lwAddBotReplyBody" class="dropdown-item btn lw-ajax-link-action" href="{{ route('vendor.ping_pong.read')}}"
                                            data-toggle="modal" data-target="#lwAddNewAdvanceBotReply"> {{ __tr('Simple Bot Reply')
                                            }}</a>
                                        <a type="button" @click="isAdvanceBot = 'media'" data-response-template="#lwAddBotReplyBody" class="dropdown-item btn lw-ajax-link-action" href="{{ route('vendor.ping_pong.read')}}"
                                            data-toggle="modal" data-target="#lwAddNewAdvanceBotReply"> {{ __tr('Media Bot Reply')
                                            }}</a>
                                        <a type="button" @click="isAdvanceBot = 'interactive'" data-response-template="#lwAddBotReplyBody" class="dropdown-item btn lw-ajax-link-action" href="{{ route('vendor.ping_pong.read')}}"
                                            data-toggle="modal" data-target="#lwAddNewAdvanceBotReply"> {{ __tr('Advance Interactive Bot Reply') }}</a>
                                        <a type="button" @click="isAdvanceBot = 'template'" data-response-template="#lwAddBotReplyBody" class="dropdown-item btn lw-ajax-link-action" href="{{ route('vendor.ping_pong.read')}}"
                                            data-toggle="modal" data-target="#lwAddNewAdvanceBotReply"> {{ __tr('Template Bot Reply') }}</a>
                                    </div>
                                </div>
                            </template>
