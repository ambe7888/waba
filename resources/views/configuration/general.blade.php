...
<div class="row">
    ...
    <div class="form-group">
        ...
        <select data-lw-plugin="lwSelectize" data-label-field="name" data-selected="{{ $configurationData['timezone'] }}" data-search-field="{{ json_encode(['id','name']) }}" data-value-field="id" id="lwSelectTimezone" name="timezone" required>
    ...
    <div class="form-group mt-2">
        ...
        <select id="lwSelectDefaultLanguage" data-lw-plugin="lwSelectize" placeholder="{{ __tr('Default Language...') }}" name="default_language">
