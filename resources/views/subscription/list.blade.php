@extends('layouts.app', ['title' => __tr('Stripe Subscriptions')])

@section('content')
@include('users.partials.header', [
'title' => __tr('Stripe Subscriptions'),
'description' => '',
'class' => 'col-lg-7'
])
    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <x-lw.datatable id="lwManageVendorsTable" :url="route('central.subscription.read.list')" data-page-length="100">
                ...
                <th data-order-by="true" data-order-type="desc" data-orderable="true" data-name="plan_type">
                    <?= __tr('Plan') ?>
                </th>
                ...
                <th data-order-by="true" data-order-type="desc" data-orderable="true" data-name="created_at">
                    <?= __tr('Created At') ?>
                </th>
