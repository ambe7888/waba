...
$('.modal').off('shown.bs.modal.modalEvent').on('shown.bs.modal.modalEvent', function (shownEvent) {
...
$('.modal').off('hidden.bs.modal.modalEvent').on('hidden.bs.modal.modalEvent', function (hiddenEvent) {
...
window.addEventListener('DOMContentLoaded', event => {
    ...
    $(document).off('onChatBoxMessageSubmit').on('onChatBoxMessageSubmit', function (event, dataResponse) {
        window.lwScrollTo('#lwEndOfChats', true);
    });

    $('.modal').off('hide.bs.modal.modalEvent').on('hide.bs.modal.modalEvent', function (e) {
      var modal = this;
