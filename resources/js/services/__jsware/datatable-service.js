(function (window, undefined) {
        ...
        var dtOptionsCollection = {
            ...
            drawCallback: function (settings) {
                ...
                api.on('page.dt', function () {
                    var $dtWrapper = $(this).parents('.lw-datatable-fixed-height');
                    if ($dtWrapper.length) {
                        $dtWrapper.find('.dt-row').animate({
                            scrollTop: 0
                        }, 'fast');
                    } else {
                        $('html, body').animate({
                            scrollTop: $(this).parents('.dataTables_wrapper').offset().top - 150 //- $dtWrapper.height()
                        }, 'fast');
                    }
                });
            },
            ...
            responsive: {
                details: {
                    display: _.get(DataTable.defaults, 'lwExpandedRowsForMobile', false) ? DataTable.Responsive.display.childRowImmediate : DataTable.Responsive.display.childRow,
                    // target: '',
                    // type: 'none',
    ...
    window.initializeDatatable = function () {
        ...
        Usages:
        default 
        data-order="8" data-order-type="desc"
        */
        // check if
