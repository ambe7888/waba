...
if (! function_exists('hasVendorAccess')) {
    ...
    function hasVendorAccess($permission = null, $nestedPermission = null)
    {
        ...
        if ((getUserAuthInfo('role_id') === 2)) {
            ...
            // if has nested permissions
            if($nestedPermission) {
                $permissionString .=  '.permissions.' . $nestedPermission;
            }
            
            return Arr::get($listOfPermissions, "$permissionString.default", true);
        }
...
if (! function_exists('getListOfPermissions')) {
    ...
    {
        return viaFlashCache('list_of_vendor_user_permissions', function () {
...
if (! function_exists('sendFCMNotification')) {
    function sendFCMNotification($vendorId, $title, $body, $data = [])
    {
        ...
        if (!$deviceTokens->isEmpty()) {
            ...
            $firebaseServiceAccountData = json_decode(getAppSettings('firebase_service_account_data'), true);
...
if (! function_exists('getAccessToken')) {
    function getAccessToken()
    {
        ...
        $firebaseServiceAccountData = getAppSettings('firebase_service_account_data');
        $client->setAuthConfig(json_decode($firebaseServiceAccountData, true));
