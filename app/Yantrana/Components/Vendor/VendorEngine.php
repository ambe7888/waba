...
class VendorEngine extends BaseEngine implements VendorEngineInterface
{
     ...
     * @return void
     *-----------------------------------------------------------------------*/
    public function __construct(AuthRepository $authRepository, VendorRepository $vendorRepository, UserRepository $userRepository, MediaEngine $mediaEngine)
    {
    ...
    *---------------------------------------------------------------- */
    ...
    public function prepareVendorPermanentDelete($vendorIdOrUid)
    {
        ...
        if ($this->vendorRepository->deleteIt($vendor)) {
            // Delete vendor media
            $this->mediaEngine->deleteVendorMediaFiles($vendor->_uid);
